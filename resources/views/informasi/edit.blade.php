    ...
    <form action='{{ url('informasi/'.$data->id) }}' method='post'>
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="date" class="form-control" name='tanggal' value="{{ old('tanggal') ?? $data->tanggal }}" id="tanggal">
                </div>
            </div>
            <div class="mb-3 row">
                <label for="judul" class="col-sm-2 col-form-label">Judul</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='judul' id="judul" value="{{ old('judul') ?? $data->judul }}">
                </div>
            </div>
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10 mt-3">
                    <img src="{{ asset($data->gambar ?? 'assets/img/placeholder.jpeg') }}" alt="" class="img-fluid" id="preview" style="width: 50%;">
                </div>
            </div>
            <div class="mb-3 row">
